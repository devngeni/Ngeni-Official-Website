          ...
          <WhatwedoHeader>
            ...
            <Mainbody>
              ...
              <Hello>
                ...
                <span>
                  &nbsp;Applications, Bots & dApps for Blockchain, Fintech,
                  Cryptocurrencies & Markets Trading
                </span>
                . We develop across the <span>Entire ECOSYSTEM</span> & 💗{" "}
                <span>&nbsp;COMPLEXITY! </span>
                Mobile Payments, API & DeFi bridges, Digital wallets...? We got
                THIS. It's in <span>OUR BLOOD</span> 😍 We’re{" "}
                <span>GENERATION M-Pesa</span>👨👨👦👦 moving money{" "}
                <span>Digitally</span> since <span>2007</span>🔥
              </Hello>
            </Mainbody>
          </WhatwedoHeader>
        </Fade>
      ...
      <FooterRow>
        ...
        <Zoom up>
          <FooterContentOne>
            ...
            <FooterHeader>
              Proudly sat above a big & super fast fibre optic cable. Consuming
              3.2 TB p/d feeding our Ethereum & BNB Chain nodes.
            </FooterHeader>
          </FooterContentOne>
        </Zoom>
      </FooterRow>
